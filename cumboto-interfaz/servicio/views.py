...
## Rest framework
@api_view(['GET'])
def consultar_rest(self):
    ## solicitud al servicio rest
    #api = requests.get('http://127.0.0.1:8888')
    api = requests.get('http://127.0.0.1:9090')
    print(api.content)
    #print("Hello")
    Tornado_servicios = json.dumps(api.content)
    return Response(Tornado_servicios)
